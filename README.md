...
안심생활은 공공혜택 목록을 보여주는 데서 끝나지 않습니다. 사용자가 자신의 상황에 맞는 혜택 후보를 좁히고, 공식 지원대상과 준비서류를 확인하고, 정확한 공식 접수처로 이동하고, 신청 이후 상태와 다음 확인일까지 관리할 수 있도록 돕습니다. 신청서에 들어갈 이름·전화번호·주소·소득정보·증빙파일은 수집하지 않습니다.
...
- 모바일·데스크톱 반응형 UI
- 긴 지원대상·혜택 문장을 임의로 자르지 않는 카드 레이아웃
- 데스크톱 두 열 카드의 제목·설명·대상·혜택·버튼 기준선 정렬
